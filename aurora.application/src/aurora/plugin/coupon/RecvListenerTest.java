 ...
 * 窗口 － 首选项 － Java － 代码样式 － 代码模板
 */
public class RecvListenerTest implements EMPPRecvListener {
    ...
    protected RecvListenerTest(){
        
    }
    
    public RecvListenerTest(EmppApi emppApi){
        ...
        if(message instanceof EMPPSubmitSMResp){
  		...
  		if(message instanceof EMPPDeliver){
  			...
  			if(deliver.getRegister()==EMPPSubmitSM.EMPP_STATUSREPORT_TRUE){
  			    ...
  			    System.out.println("seq="+report.getSeqId());
