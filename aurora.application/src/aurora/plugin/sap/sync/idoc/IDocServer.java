...
public class IDocServer {
	...
	public DataBaseUtil getConnection() throws SQLException, AuroraIDocException {
...
//	}
	...
	public boolean isEnableInterfaceHistory() {
		return isEnableInterfaceHistory;
	}
	public void setEnableInterfaceHistory(boolean isEnableInterfaceHistory) {
		this.isEnableInterfaceHistory = isEnableInterfaceHistory;
	}
