...
@javax.servlet.annotation.WebServlet(
	...
	public class ComplexAsyncServletForChat extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -649001656309745137L;
	...
	private void enqueLongRunningTask(final AsyncContext ctx) {
	  ...
	  exec.execute(new Runnable() {
	    public void run() {
	      ...
	      try {
	    	 String name = ctx.getRequest().getParameter("user");
	    	 String msg = ctx.getRequest().getParameter("msg");
